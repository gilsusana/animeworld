...
<div class="container col-xxl-8 px-4 py-5">
    <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
      ...
      <div class="col-lg-6">
        ...
        <p class="lead fw-bolder">Año: <?php echo $row['año']; ?></p>
        <p class="lead fw-normal">Dirección: <?php echo $row['direccion']; ?></p>
        <p class="lead fw-normal">Guión: <?php echo $row['guion']; ?></p>
